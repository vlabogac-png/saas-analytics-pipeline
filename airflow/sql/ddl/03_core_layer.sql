...
-- fact_daily_user_activity (daily aggregations)
...
COMMENT ON TABLE core.dim_users IS 'User dimension with SCD Type 2 support';
COMMENT ON TABLE core.dim_documents IS 'Document dimension';
COMMENT ON TABLE core.dim_features IS 'Product features dimension';
COMMENT ON TABLE core.dim_date IS 'Date dimension (2020-2026)';
COMMENT ON TABLE core.fact_events IS 'Granular event-level facts';
COMMENT ON TABLE core.fact_daily_user_activity IS 'Daily aggregated user activity metrics';
